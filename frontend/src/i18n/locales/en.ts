...
export const en = {
  ...
  formTemplates: {
    ...
    save: {
      ...
      overwriteTitle: 'Overwrite template?',
      overwriteHint: 'A template with this name already exists and will be overwritten.',
      previewTitle: 'These fields will be saved',
      skippedHint: 'These fields are not saved (not eligible):',
      stepPreview: 'Preview',
      stepName: 'Name',
      next: 'Next',
      back: 'Back',
    ...
    apply: {
      ...
      empty: 'No templates saved for this form yet.',
      searchPlaceholder: 'Search template',
      noResults: 'No matching templates.',
      apply: 'Apply',
      stepSelect: 'Selection',
      stepPreview: 'Preview',
      appliedTitle: 'These fields will be applied',
      removeDriftFields: 'Remove no longer supported fields from the template',
      back: 'Back',
      overwriteTitle: 'Overwrite fields?',
      overwriteConfirm:
        'Some fields you already filled in will be overwritten by the template. Apply anyway?',
      success: 'Template applied',
      loadError: 'Template could not be loaded. Please try again.',
    },
    preview: {
      title: 'Preview',
      skippedHint: 'These fields are no longer applied (changed or removed in the form):',
    ...
    delete: {
      ...
      message: 'Do you really want to delete the template {{name}}?',
      action: 'Delete',
  ...
  numberRanges: {
    title: 'Number ranges',
    intro:
      'Ranges you may see: every range for global admins, otherwise those declared by a workflow you own.',
    range: 'Range',
    table: 'Table',
    workflows: 'Workflows',
    scope: 'Scope',
    ...
    draw: 'Draw',
    issuedAt: 'Issued at',
    allocationsOf: 'Allocations of {{name}}',
    selectRange: 'Select a range to see its allocations.',
    noRanges: 'No number ranges are visible to you.',
    total: '{{count}} numbers',
  ...
  data: {
    modelsTitle: 'Data',
    noModels: 'No data models available.',
    actions: 'Actions',
    modelName: 'Name',
    rowCount: 'Count',
    ...
    confirmStartHeader: 'Start workflow',
    confirmStartText: 'Start the follow-up workflow "{{label}}" for this record?',
    start: 'Start',
    cancel: 'Cancel',
    yes: 'Yes',
    no: 'No',
    history: 'History',
    historyPanelTitle: 'Version history ({{count}})',
    currentVersion: 'Current',
    viewingOldVersion: 'Older version from {{date}}.',
    actionsOnlyOnCurrent: 'Actions are only available on the current version.',
    backToCurrent: 'Back to current version',
    notFound: 'Record not found.',
    openDiagramHint: 'Open process diagram',
