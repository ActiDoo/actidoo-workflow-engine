...
export const de = {
  ...
  formTemplates: {
    ...
    save: {
      title: 'Formular als Vorlage speichern',
      namePlaceholder: 'Vorlagenname',
      overwriteTitle: 'Vorlage überschreiben?',
      overwriteHint: 'Eine Vorlage mit diesem Namen existiert bereits und wird überschrieben.',
      previewTitle: 'Diese Felder werden gespeichert',
      skippedHint: 'Diese Felder werden nicht gespeichert (nicht erlaubt):',
    ...
    apply: {
      ...
      empty: 'Für dieses Formular wurden noch keine Vorlagen gespeichert.',
      searchPlaceholder: 'Vorlage suchen',
      noResults: 'Keine passenden Vorlagen.',
      apply: 'Anwenden',
      stepSelect: 'Auswahl',
      stepPreview: 'Vorschau',
      appliedTitle: 'Diese Felder werden angewendet',
      removeDriftFields: 'Nicht mehr unterstützte Felder aus dem Template entfernen',
      back: 'Zurück',
      overwriteTitle: 'Felder überschreiben?',
      overwriteConfirm:
        'Einige bereits ausgefüllte Felder werden durch die Vorlage überschrieben. Trotzdem anwenden?',
      success: 'Vorlage angewendet',
      loadError: 'Vorlage konnte nicht geladen werden. Bitte versuche es erneut.',
    },
    preview: {
      title: 'Vorschau',
      skippedHint:
        'Diese Felder werden nicht mehr übernommen (im Formular geändert oder entfernt):',
      fileSingular: '{{count}} Datei',
      filePlural: '{{count}} Dateien',
      emptyValue: '—',
    },
    delete: {
      title: 'Vorlage löschen',
      message: 'Möchtest du die Vorlage {{name}} wirklich löschen?',
      action: 'Löschen',
  ...
  numberRanges: {
    title: 'Nummernkreise',
    intro:
      'Sichtbar sind für globale Admins alle Kreise, sonst die, die ein eigener Workflow deklariert.',
    range: 'Kreis',
    table: 'Tabelle',
    workflows: 'Workflows',
    scope: 'Scope',
    ...
    lastNumber: 'Letzte Nummer',
    lastIssued: 'Zuletzt vergeben',
    number: 'Nummer',
    sequence: 'Sequenz',
    instance: 'Workflow-Instanz',
    step: 'Schritt',
    draw: 'Ziehung',
    issuedAt: 'Vergeben am',
    allocationsOf: 'Vergaben von {{name}}',
    selectRange: 'Kreis auswählen, um seine Vergaben zu sehen.',
    noRanges: 'Für dich sind keine Nummernkreise sichtbar.',
    total: '{{count}} Nummern',
  ...
  dialogStartWorkflow: {
    ...
    start: 'Starten',
    pin: 'Workflow anheften',
    unpin: 'Workflow ablösen',
  ...
  data: {
    modelsTitle: 'Daten',
    noModels: 'Keine Datenmodelle verfügbar.',
    actions: 'Aktionen',
    modelName: 'Name',
    rowCount: 'Anzahl',
    ...
    confirmStartHeader: 'Workflow starten',
    confirmStartText: 'Folge-Workflow „{{label}}“ für diesen Datensatz starten?',
    start: 'Starten',
    cancel: 'Abbrechen',
    yes: 'Ja',
    no: 'Nein',
    history: 'Historie',
    historyPanelTitle: 'Versionshistorie ({{count}})',
    currentVersion: 'Aktuell',
    viewingOldVersion: 'Ältere Version vom {{date}}.',
    actionsOnlyOnCurrent: 'Aktionen sind nur auf der aktuellen Version verfügbar.',
    backToCurrent: 'Zur aktuellen Version',
    notFound: 'Datensatz nicht gefunden.',
    openDiagramHint: 'Prozessdiagramm öffnen',
    showFullIds: 'Vollständige IDs anzeigen',
    shortenIds: 'IDs verkürzt anzeigen',
    versionAction: {
      CREATE: 'Angelegt',
      UPDATE: 'Geändert',
    },
