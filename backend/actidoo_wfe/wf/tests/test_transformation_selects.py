...
PATH_FORM = "./actidoo_wfe/wf/tests/forms/test_selects.form"
PATH_SNAPSHOT_JSONSCHEMA = "./actidoo_wfe/wf/tests/snapshots/selects_jsonschema.json"
PATH_SNAPSHOT_UISCHEMA = "./actidoo_wfe/wf/tests/snapshots/selects_uischema.json"
