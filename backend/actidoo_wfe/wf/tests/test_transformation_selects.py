...
PATH_FORM = TESTS_DIR / "forms" / "test_selects.form"
PATH_SNAPSHOT_JSONSCHEMA = TESTS_DIR / "snapshots" / "selects_jsonschema.json"
PATH_SNAPSHOT_UISCHEMA = TESTS_DIR / "snapshots" / "selects_uischema.json"
